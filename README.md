...
- Gosto também de documentar através de posts as soluções que encontrei durante a minha jornada como programador no meu [blog](https://gustavosouza.dev.br/blog/) como uma forma de contribuir não somente para a comunidade de Devs, como também para aqueles principalmente que estão em inicio de carreira. 
