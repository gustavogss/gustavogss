...
- Sou aluno da [TRYBE](https://www.betrybe.com/) uma escola de programação em Desenvolvimento Web FullStack, que ensina além das tecnologias fullstack mais cobiçadas do mercado, a vivência em trabalhar em equipe com métodos ágeis, e também habilidades comportamentais como colaboração, comunicação, resiliência, empatia, escuta ativa, autogestão. ⭐
